    ...
    <main>
        ...
        <section id="theme">
            ...
            <figure style="display: flex; flex-direction: column; align-items: center; text-align: center;">
                <img src="DX-Mamba.png" alt="Figure 1: Workflow of the proposed DX-Mamba model" text-align: center style="width: 800px;">
                <figcaption style="margin-top: 10px; font-style: italic; color: #555;">Figure 1: Workflow of the proposed DX-Mamba model</figcaption>
            </figure>
